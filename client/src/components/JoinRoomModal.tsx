...
const JoinRoomModal = ({ onClose, onJoined }: Props) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. A3FX9K"
              maxLength={6}
              autoFocus
              className="w-full px-4 py-2.5 bg-slate-900 border border-slate-600 rounded-lg text-white placeholder-slate-500 font-mono tracking-widest text-center text-lg uppercase focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition"
            />
            <p className="text-slate-500 text-xs mt-1 text-center">
              Ask the room owner for their 6-character invite code
            </p>
          </div>
